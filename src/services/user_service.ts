...
export class UsersService {
    ...
    async changePassword(changeReq: UserChangePasswordRequest): Promise<ChangePasswordResponse> {
        const resp = await this.api.patch(`/user/${changeReq.userId}/changePassword`).catch(err => err.response);
    ...
    async changeEmail(changeReq: UserChangePasswordRequest): Promise<ChangeEmailResponse> {
        const resp = await this.api.patch(`/user/${changeReq.userId}/changeEmail`).catch(err => err.response);
    ...
    async changeUsername(changeReq: UserChangePasswordRequest): Promise<ChangeUsernameResponse> {
        const resp = await this.api.patch(`/user/${changeReq.userId}/changeUsername`).catch(err => err.response);
